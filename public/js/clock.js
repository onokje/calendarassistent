...
setCaptions = function() {
  ...
  $('.clockDot.hour').attr('d', describeArc(600, 240, 150, hourArc - 3, hourArc));
  $('.clockDot.minute').attr('d', describeArc(600, 240, 170, minArc - 1, minArc));
  dot = $(".clockDot.hour");
  pos = polarToCartesian(600, 240, 150, hourArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
  dot = $(".clockDot.minute");
  pos = polarToCartesian(600, 240, 170, minArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
